...
namespace usb_python2
{
	...
	constexpr int P2IO_JAMMA_TOYSMARCH_P1_START = 0x00000100;
	constexpr int P2IO_JAMMA_TOYSMARCH_P1_LEFT = 0x00000800;
	constexpr int P2IO_JAMMA_TOYSMARCH_P1_RIGHT = 0x00001000;

	constexpr int P2IO_JAMMA_TOYSMARCH_P2_START = 0x00010000;
	constexpr int P2IO_JAMMA_TOYSMARCH_P2_LEFT = 0x00080000;
	constexpr int P2IO_JAMMA_TOYSMARCH_P2_RIGHT = 0x00100000;
	...
	public:
		...
		virtual void UpdateKeyStates(LPWSTR keybind) = 0;
		virtual bool GetKeyState(LPWSTR keybind) = 0;
		virtual bool GetKeyStateOneShot(LPWSTR keybind) = 0;
